...
![](/assets/images/ghost_images/2023/01/image-1.png)변경 전![](/assets/images/ghost_images/2023/01/image-2.png)변경 후
## 2. 스프링이 없다고 가정하면
...
![](/assets/images/ghost_images/2023/01/image-3.png)DI 컨테이너
...
![](/assets/images/ghost_images/2023/01/image-4.png)@SpringBootApplication 하위에 컴포넌트 스캔 옵션이 나열되어 있다.
...
![](/assets/images/ghost_images/2023/01/image-5.png)전체 테스트 실행 결과
...
![](/assets/images/ghost_images/2023/01/image-6.png)Configuration 애노테이션 내부
...
![](/assets/images/ghost_images/2023/01/image-7.png)테스트 실행 결과
