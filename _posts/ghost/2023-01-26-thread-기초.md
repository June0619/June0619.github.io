...
## 1. 스레드의 개념
![](/assets/images/ghost_images/2023/01/image-9.png)운영체제 - 프로세스의 개념 도식
...
![](/assets/images/ghost_images/2023/01/image-10.png)1번과 2번에 대한 실행 결과
...
![](/assets/images/ghost_images/2023/01/image-11.png)병렬처리가 되지 않고 메인스레드에서 순차적으로 실행되고 있다.
## 4. 스레드의 상태
...
![](/assets/images/ghost_images/2023/01/image-12.png)스레드의 상태 도식
### 4-2. Runnable 상태
...
![](/assets/images/ghost_images/2023/01/image-13.png)반드시 위 순서대로 작동을 보장하지는 않는다.
...
![](/assets/images/ghost_images/2023/01/image-14.png)비교적(?) 균등하게 교차되고 있다.
...
![](/assets/images/ghost_images/2023/01/image-15.png)join() 메서드의 사용 결과
...
![](/assets/images/ghost_images/2023/01/image-16.png)다음과 같이 인위적으로 스레드 실행 순서를 제어하는 것도 가능하다.
## 6. 스레드 동기화
...
![](/assets/images/ghost_images/2023/01/image-17.png)잘못된 결과 1![](/assets/images/ghost_images/2023/01/image-18.png)잘못된 결과 2
...
![](/assets/images/ghost_images/2023/01/image-19.png)
---
